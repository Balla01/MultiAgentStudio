...
def generate_answer_crew(query: str, context_text: List[Dict[str, Any]]) -> str:
    if not context_text:
...
def milvus_inference(user_query: str, COLLECTION_NAME: str):
...
if __name__ == "__main__":
    ...
    work_item_name = "itf_testing"
    milvus_inference(user_query, work_item_name)
